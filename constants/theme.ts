...
// Emotion mapping — covers all 50 emotions from the ML API
export const EMOTION_MAP: Record<string, { icon: string; color: string; label: string }> = {
  ...
  anger: { icon: 'flame-outline', color: '#DC2626', label: 'Anger' },
  ...
  // ── Extended emotions from ML API ──
  grief: { icon: 'water-outline', color: '#4A6FA5', label: 'Grief' },
  loneliness: { icon: 'person-outline', color: '#708090', label: 'Loneliness' },
  despair: { icon: 'cloudy-night-outline', color: '#4A5568', label: 'Despair' },
  hopelessness: { icon: 'moon-outline', color: '#4A5568', label: 'Hopelessness' },
  confusion: { icon: 'help-circle-outline', color: '#8B5CF6', label: 'Confusion' },
  guilt: { icon: 'alert-circle-outline', color: '#B45309', label: 'Guilt' },
  shame: { icon: 'eye-off-outline', color: '#9B2335', label: 'Shame' },
  jealousy: { icon: 'flash-outline', color: '#059669', label: 'Jealousy' },
  envy: { icon: 'swap-horizontal-outline', color: '#047857', label: 'Envy' },
  pride: { icon: 'ribbon-outline', color: '#D97706', label: 'Pride' },
  humility: { icon: 'trending-down-outline', color: '#2D6A4F', label: 'Humility' },
  contentment: { icon: 'checkmark-circle-outline', color: '#52B788', label: 'Contentment' },
  serenity: { icon: 'water-outline', color: '#38BDF8', label: 'Serenity' },
  awe: { icon: 'sparkles-outline', color: '#8B5CF6', label: 'Awe' },
  wonder: { icon: 'telescope-outline', color: '#A855F7', label: 'Wonder' },
  excitement: { icon: 'rocket-outline', color: '#F59E0B', label: 'Excitement' },
  happiness: { icon: 'happy-outline', color: '#34D399', label: 'Happiness' },
  sorrow: { icon: 'sad-outline', color: '#6B7280', label: 'Sorrow' },
  regret: { icon: 'arrow-undo-outline', color: '#9CA3AF', label: 'Regret' },
  frustration: { icon: 'ban-outline', color: '#EF4444', label: 'Frustration' },
  disappointment: { icon: 'thumbs-down-outline', color: '#9CA3AF', label: 'Disappointment' },
  worry: { icon: 'warning-outline', color: '#D97706', label: 'Worry' },
  stress: { icon: 'pulse-outline', color: '#EF4444', label: 'Stress' },
  overwhelm: { icon: 'layers-outline', color: '#7C3AED', label: 'Overwhelm' },
  nervousness: { icon: 'walk-outline', color: '#F59E0B', label: 'Nervousness' },
  courage: { icon: 'shield-outline', color: '#2563EB', label: 'Courage' },
  determination: { icon: 'trophy-outline', color: '#D97706', label: 'Determination' },
  compassion: { icon: 'people-outline', color: '#EC4899', label: 'Compassion' },
  empathy: { icon: 'heart-half-outline', color: '#F472B6', label: 'Empathy' },
  devotion: { icon: 'flame-outline', color: '#D4AF37', label: 'Devotion' },
  submission: { icon: 'chevron-down-outline', color: '#2D6A4F', label: 'Submission' },
  reliance: { icon: 'link-outline', color: '#3B82F6', label: 'Reliance' },
  thankfulness: { icon: 'gift-outline', color: '#F97316', label: 'Thankfulness' },
  yearning: { icon: 'search-outline', color: '#8B5CF6', label: 'Yearning' },
  nostalgia: { icon: 'time-outline', color: '#A78BFA', label: 'Nostalgia' },
  acceptance: { icon: 'checkmark-done-outline', color: '#10B981', label: 'Acceptance' },
  vulnerability: { icon: 'umbrella-outline', color: '#F472B6', label: 'Vulnerability' },
  inspiration: { icon: 'color-wand-outline', color: '#FBBF24', label: 'Inspiration' },
};
